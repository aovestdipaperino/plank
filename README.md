...
- **`/btw`** — ask a quick side question over the shared conversation context without touching it: one tool-free response, nothing enters the transcript, and the KV cache rolls back automatically on the next real turn.
