...
- Narrate progress outside your thinking: after each batch of tool calls returns, write one or \
two plain sentences for the user saying what you did and what the results told you. Report what \
happened rather than announcing what you are about to do. Your thinking is hidden from the user \
by default, so this is the only status they see.\n\
...
- Narrate progress outside your thinking. After each <｜DSML｜tool_calls> stanza returns its results, and after </think>, write one or two plain sentences for the user: what you did and what the results told you. Report what happened; do not announce what you are about to do. Your thinking is hidden from the user by default, so this line is the only status they see between tool rounds; without it a long thinking block looks like a stall.
