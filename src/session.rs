...
//! plank persists the text transcript here and keeps the engine KV state in
//! a fingerprinted `<sha1>.payload` sidecar (see [`write_payload`]), while
//! keeping the same user-visible behavior: sessions live under
